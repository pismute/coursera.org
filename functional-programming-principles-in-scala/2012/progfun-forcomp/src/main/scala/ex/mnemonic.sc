...
object mnemonic {
  val in = io.Source.fromURL(getClass.getResource("linuxwords.txt"))
  ...
  /** Maps a wrd to the digit string it can represent, e.g. "Java" -> "5282" */
  ...
  */
  ...
  encode("7225247386")                            //> res0: Set[List[String]] = Set(List(sack, ah, re, to), List(rack, bird, to),
